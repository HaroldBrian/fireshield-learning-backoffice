      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <select
              value={filters.level || ''}
              onChange={(e) => handleFiltersChange({ level: e.target.value })}
              className="input-field"
            >
            ...
            <div className="flex space-x-2">
              <input
                ...
                onChange={(e) => handleFiltersChange({ priceMin: e.target.value ? parseInt(e.target.value) : undefined })}
                className="input-field"
              />
              <input
                type="number"
                ...
                onChange={(e) => handleFiltersChange({ priceMax: e.target.value ? parseInt(e.target.value) : undefined })}
                className="input-field"
              />
            </div>
          </div>
